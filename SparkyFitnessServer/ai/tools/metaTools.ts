...
export const CATEGORY_SUMMARIES: Record<ChatToolCategorySlug, string> = {
  food: 'log meals/water, search foods, view diaries, favorites, pantry stock, shopping lists, dated meal plans, meal suggestions, custom nutrients, water containers, allergens, and barcode lookup (tools: sparky_manage_food, sparky_list_foods, sparky_get_food_details, sparky_search_foods, sparky_get_food_diary, sparky_get_nutrition_summary, sparky_get_recent_food_entries, sparky_get_food_usage, sparky_manage_favorites, sparky_manage_meal_plans, sparky_suggest_next_meal, sparky_get_meal_planning_dashboard, sparky_generate_meal_plan, sparky_update_planned_meal, sparky_replace_planned_meal, sparky_confirm_grocery_purchase, sparky_manage_meal_pantry, sparky_manage_custom_nutrients, sparky_manage_water_containers, sparky_manage_allergens, sparky_get_barcode)',
  exercise:
    'log and plan workouts, learn training preferences, manage Speediance workouts, search exercises, view exercise diaries, and inspect exercise stats/analytics (tools: sparky_manage_exercise, sparky_list_exercises, sparky_get_exercise_details, sparky_search_exercises, sparky_get_exercise_diary, sparky_get_daily_exercise_totals, sparky_get_recent_exercise_entries, sparky_get_exercise_usage, sparky_get_exercise_progress, sparky_get_exercise_stats, sparky_manage_training_feedback, sparky_manage_workout_plans, sparky_search_speediance_exercises, sparky_manage_speediance_workouts)',
  checkin:
