...
const PASSWORD_CREDENTIAL_PROVIDER_TYPES: ReadonlySet<string> = new Set([
  'speediance',
  'igpsport',
]);
...
async function getExternalDataProviders(
  ...
  try {
    ...
    // log('debug', `getExternalDataProviders: Raw query results for user ${targetUserId}:`, result.rows);
