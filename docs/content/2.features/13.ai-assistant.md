...
- **Dated Meal Plans**: Sparky can create and display a one-to-seven-day breakfast/lunch/dinner plan with exact ingredient quantities, calories, protein, carbohydrates, fat, and preparation steps. Planning only reserves ingredients. Physical stock is deducted once the meal is marked prepared; eating outside, skipping, or replacing a meal releases the old reservation and recalculates the shopping list.
