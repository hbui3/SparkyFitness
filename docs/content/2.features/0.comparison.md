...
- **No online grocery ordering or macro/carb cycling scheduling.** The coach now keeps a persistent owner-only pantry and editable shopping list, but Swiss retailer links are snapshots and it does not place Coop/Migros orders or claim live prices or availability.
- **No server-side medication or cycle reminders.** Those health reminders are local notifications from the mobile app; the AI coach has its own server-side daily, weekly, and pantry-restock messages, while cycle and ovulation reminders remain on the roadmap.
