...
| `coach_profiles` | Persistent AI coach dietary constraints, preferences, routines, and proactive-message schedules; canonical goals are read from owner data | Owner-Only | Owner-Only |
