...
| `external_provider_types`   | Provider configuration metadata (FatSecret, USDA, Speediance, iGPSPORT)                              |
| `external_data_providers`   | Configured API integrations with encrypted per-user credentials                                      |
