...
- Complete Speediance workout building/editing, warm-up blocks, set modes, and calendar reservations: `src/pages/Exercises/SpeedianceWorkoutManager.tsx` plus the matching Exercises API/hook files. Speediance is intentionally excluded from the generic Online exercise importer because workout-safe variants require dedicated validation.
